...
void main() async
{
  ...
  final storage = await HydratedStorage.build( // builds hydratedstorage
    storageDirectory: HydratedStorageDirectory("C:/Users/lucas/OneDrive/Documents/App Dev Projects/labs/hydrate_chess/states"),
  ); // i couldn't figure out the directory/hydratedstoragedirectory interaction so this is hardcoded for now
...
class Square extends StatelessWidget
{
  ...
  Square(this.here, this.letter, {super.key}) : light = ( (here.r+here.c)%2==1 )
